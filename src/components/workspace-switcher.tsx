...
import { Check, ChevronsUpDown, PlusCircle, LayoutDashboard } from "lucide-react"
...
export function WorkspaceSwitcher({ workspaces, currentWorkspaceId, currencies }: WorkspaceSwitcherProps) {
